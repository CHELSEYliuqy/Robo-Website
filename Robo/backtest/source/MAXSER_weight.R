...
MAXSER_weight <- function(X, F=NULL, screening=FALSE, Num.Screen=50, sigma, K=10, given.picks=NULL, given.theta=NULL, est='theta-all')
{
  ...
  if(is.null(F) == FALSE){
    ...
    outlist <- list(lars.est=lars.est, zeta.star=zeta.star, l1norm=l1norm,
                    ...
                    Beta=Beta, Alpha=Alpha, E=E, rmse=rmse, r_c=r_c)
  }
