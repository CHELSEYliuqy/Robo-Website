...
root_dir <- '/home/huangruizhao'
work_dir <- 'Robo-Website/Robo/backtest'
base_result_dir <- '/home/huangruizha/MAXSER/MAXSER-BACKTEST-V3/Backtest_Results_v3'
save_dir <- file.path(root_dir, 'Robo-Website/Robo/bt_outcome')
base_sigma <- 0.18
base_port <- c('EW', 'Factor', 'Risk_Parity', 'Min_Var', 'MAXSER', 'MAXSER_H',
               'MAXSER_Stock_Long_Only', 'MAXSER_ALL_Long_Only', 'MAXSER_H_Stock_Long_Only', 'MAXSER_H_ALL_Long_Only')
risk_non_port <- c('EW', 'Risk_Parity', 'Min_Var')
