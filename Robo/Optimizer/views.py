...
# def result(request):
#     param = {}
#     R_run_list = ['Rscript', '/Users/ruizhaohuang/Desktop/Robo/Robo/trail.R']
...
#
#
#     stat = pd.read_csv('/Users/ruizhaohuang/Desktop/Robo/Robo/bt_outcome/SSE50/stat.csv')
#     cumret_all = pd.read_csv('/Users/ruizhaohuang/Desktop/Robo/Robo/bt_outcome/SSE50/cumret_all.csv')
#     dd_all = pd.read_csv('/Users/ruizhaohuang/Desktop/Robo/Robo/bt_outcome/SSE50/drawdown_all.csv')
#     latest_wts = pd.read_csv('/Users/ruizhaohuang/Desktop/Robo/Robo/bt_outcome/SSE50/MAXSER_ALO_latest_wts.csv')
#     wts_summary = pd.read_csv('/Users/ruizhaohuang/Desktop/Robo/Robo/bt_outcome/SSE50/MAXSER_ALO_wts_summary.csv')
#
#     rtn = {}
#     dd = {}
#     smy = {}
